...
public class SortKeyValueMap {
    ...
    public static void main(String args[]) {
		...
		/*
		 * //Sorting Map by keys in Java using Google Collections (Guava) //Main benefit
		 * is you can specify any ordering like natural or toString or arbitrary
